...
ggsave(filename = here::here("Figs", "h(x) holding other vars at 50th.jpeg"),
...
ggsave(filename = here::here("Figs", "h(x) holding other vars at 25th.jpeg"),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggsave(filename = here::here("Figs", "h(x) holding other vars at 75th.jpeg"),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggsave(filename = here::here("Figs", "h(x1, x2) holding other vars at 50th.jpeg"),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred.resp.bivar.25, aes(z1, z2, fill = est)) + 
  ...
  ylab("expos2") +
  ggtitle("h(expos1, expos2)")
ggsave(filename = here::here("Figs", "h(x1, x2) holding other vars at 25th.jpeg"),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(pred.resp.bivar.75, aes(z1, z2, fill = est)) + 
  ...
  ylab("expos2") +
  ggtitle("h(expos1, expos2)")
ggsave(filename = here::here("Figs", "h(x1, x2) holding other vars at 75th.jpeg"),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(risks.overall, aes(quantile, est, ymin = est - 1.96*sd, ymax = est + 1.96*sd)) + 
  ...
  geom_pointrange()
ggsave(filename = here::here("Figs", "Overall risk relative to 50th.jpeg"),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(risks.singvar, aes(variable, est, ymin = est - 1.96*sd, 
  ...
  coord_flip()
ggsave(filename = here::here("Figs", "Individual risk 25th to 75th.jpeg"),
       device = "jpeg", height = 5, width = 5, units = "in")
...
ggplot(risks.int, aes(variable, est, ymin = est - 1.96*sd, 
  ...
  geom_pointrange(position = position_dodge(width = 0.75)) + 
  coord_flip()
ggsave(filename = here::here("Figs", "Interactions 25th to 75th.jpeg"),
       device = "jpeg", height = 5, width = 5, units = "in")
...
save(pred.resp.univar.25, pred.resp.univar.50, pred.resp.univar.75,
     ...
     file = here::here("Results", "BKMR_Model_BW_Results.rdata"))
