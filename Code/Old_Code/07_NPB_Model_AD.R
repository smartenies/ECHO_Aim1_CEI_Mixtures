...
#' 
#' Description: Using Lauren's mmpack to run NBP on the HS data set using percent
#' adiposity as the outcome of interest
#' =============================================================================
...
#'     In general, the direction of the associations is what we expect (negative)
#' -----------------------------------------------------------------------------

set.seed(123)

#' Try with with default priors
...
#' Going to use the last set of priors

#' -----------------------------------------------------------------------------
#' Fitting the nonparametric Bayesian shrinkage model:
#' Going to go with the thrid set of priors as described above
#' Because this is a screening model, going to set PIP criterion to 0.25
#' -----------------------------------------------------------------------------
...
#' 10 variables had PIPs above 0.40
...
save(priors.npb, fit.npb, npb.sum, exp_names,
     file = here::here("Results", "NPB_Models_AD.rdata"))
