---
title: "NPB to select exposures for the BKMR model of adiposity"
...
This markdown summarizes the NPB analsys trying to reduce the number of predictors for the BKMR model for adiposity. 
...
- Overall, I ended up with 10 exposures with PIPs > 0.4.
...
We have complete outcome, exposure, and covariate data for `r paste0(round((nrow(hs_data2)/ nrow(hs_data)) * 100, 1), "%")` of participants. Note: the adiposity models include days to PEAPOD measurement.
...
Similar to the model for birth weight, I fit test models with different sets of priors for the NPB model. I went with the 5th set here, just like I did for the previous birth weight model.
