...
# Linear model with the ozone predictor

The GAM model indicates a non-linear relationship between O3 and birth weight, None of the other exposures had a PIP > 0.5. 
Remember that the exposure and covariates have all been scaled.
...
# Try a GAM with the ozone predictor
...
```{r}
jpeg(here::here("Figs", "Ozone_GAM_Birth_Weight_v4.jpeg"))
...
```{r}
jpeg(here::here("Figs", "Ozone_GAM_Birth_Weight_Sensitivity_v4.1.jpeg"))
plot(bw_gam2, main = "GAM with a smoothing term for ozone",
     xlab = "Ozone (scaled)", ylab = "Change in birth weight (g)")
dev.off()
```

# GAM Sensitivity Analysis no. 2
...
```{r}
jpeg(here::here("Figs", "Ozone_GAM_Birth_Weight_Sensitivity_v4.2.jpeg"))
